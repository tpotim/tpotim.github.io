...
var i;return ie.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ie.css(t,n,a):ie.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ie.fn.size=function(){return this.length},ie.fn.andSelf=ie.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ie});var on=e.jQuery,an=e.$;return ie.noConflict=function(t){return e.$===ie&&(e.$=an),t&&e.jQuery===ie&&(e.jQuery=on),ie},typeof t===Ce&&(e.jQuery=e.$=ie),ie}),jQuery(document).ready(function(e){e(".click-clear-text").on("click",function(){var t=e(".clear-relative #icon_prefix").val(),n=e(".clear-relative label").text();return n==t?!1:(e(".clear-relative #icon_prefix").val(" "),void e(".clear-relative label").removeClass("active"))}),e("#submitBtn").click(function(){var t=60;e("#submitBtn").attr("disabled","disabled").text(t+"秒").addClass("btn-disable");var n=setInterval(function(){t--,e("#submitBtn").text(t+"秒"),0===t&&(clearInterval(n),e("#submitBtn").removeAttr("disabled").text("获取验证码").removeClass("btn-disable"))},1e3)}),e("#password-cont").togglePassword({el:"#togglePassword"})}),function(e){e.fn.togglePassword=function(t){var n=e.extend(e.fn.togglePassword.defaults,t),r=e(this);e(n.el).bind(n.ev,function(){"password"==e(r).attr("type")?e(r).attr("type","text"):e(r).attr("type","password")})},e.fn.togglePassword.defaults={ev:"click"}}(jQuery);