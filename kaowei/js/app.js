...
app.config(function($routeProvider) {
  $routeProvider
    ...
    .when('/detail',              {templateUrl: 'views/detail222.html', controller: 'detailCtrl', reloadOnSearch: false})
    .when('/unbind-success',              {templateUrl: 'views/unbind_success.html', controller: 'checkCtrl', reloadOnSearch: false})
    .when('/share',              {templateUrl: 'views/share.html', controller: 'shareCtrl', reloadOnSearch: false})
    .otherwise({
      redirectTo: '/login'
    });
